...
const Header: FC = memo(() => {
  ...
  const navSections = useMemo(
    () => [SectionId.Hero, SectionId.About, SectionId.Education, SectionId.Experience,SectionId.InformationM, SectionId.Projects, SectionId.Portfolio, SectionId.Skills, SectionId.Contact],
    [],
  );
